  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-gradient': 'linear-gradient(135deg, rgba(15, 23, 42, 0.9) 0%, rgba(30, 41, 59, 0.8) 50%, rgba(51, 65, 85, 0.7) 100%)',
      },
      animation: {
      ...
      boxShadow: {
        ...
        'gaming': '0 4px 14px 0 rgba(0, 245, 255, 0.3)',
        'gaming-lg': '0 10px 25px 0 rgba(0, 245, 255, 0.4)',
        'inner-glow': 'inset 0 0 10px rgba(0, 245, 255, 0.3)',
      },
      backdropBlur: {
        'xs': '2px',
      },
